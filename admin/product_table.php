                 ...
                 <table class="table align-items-center table-flush table-borderless">
                  <thead>
				   ...
				   while($arrayy = mysqli_fetch_array($queryy)){  
                    ...
                    <td><img src="img/frontphoto/<?php echo $arrayy ['image'];?>" class="product-img" alt="product img"></td>
					<td><img  src="img/backphoto/<?php echo $arrayy ['dimage'];?>" class="product-img" alt="product img"></td>
